...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About & Location — AfricanRoyal Villa" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "About & Location — AfricanRoyal Villa" },
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="py-16 px-6 max-w-4xl mx-auto space-y-6 text-lg text-espresso/80 leading-relaxed">
        <p>
          AfricanRoyal Villa &amp; Campsite began as a working farm on the edge of the Karatu
      ...
      <section className="pb-24 px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
        ...
        <div className="aspect-video rounded-2xl overflow-hidden border border-espresso/10">
          <iframe
            title="AfricanRoyal Villa location — Karatu, Tanzania"
